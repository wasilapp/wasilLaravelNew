...
<html lang="en">
    ...
    <body class="authentication-bg">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-4">
                                    <div class="text-center mt-3 pl-1 pr-1">
                                        ...
                                        <p class="text-white-50">If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embar.. <a href="mailto:support@coderthemes.com" class="text-white-50 font-weight-bold">support@coderthemes.com</a></p>
                                    </div>
                                </div> <!-- end col-->
                            </div> <!-- end row-->
                        </div> <!-- end /.text-center-->
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy; {{env('APP_NAME')}} by <a href="" class="text-white-50">{{env('COMPANY_NAME')}}</a>
        </footer>
