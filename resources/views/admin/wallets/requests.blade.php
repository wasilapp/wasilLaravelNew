                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{__('admin.wallets-requests')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('admin.wallets-requests')}}</h4>
                </div>
            </div>
        </div>
                                ...
                                @foreach($wallets as $wallet)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-2">
                                            <form action="{{ route('admin.wallets-requests.accept', ['id' => $wallet->id]) }}" method="POST">
                                                @csrf
                                            ...
                                            <form action="{{ route('admin.wallets-requests.decline', ['id' => $wallet->id]) }}" method="POST">
                                                @csrf
