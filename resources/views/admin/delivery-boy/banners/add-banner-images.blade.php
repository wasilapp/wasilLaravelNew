                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.drivers-banners.create')}}">{{__('admin.banners')}}</a></li>
                            <li class="breadcrumb-item active">{{__('admin.edit')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('admin.add_banners')}}</h4>
                    <form class="row" action="{{ route('admin.drivers-banners.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                ...
                                <input class="form-check-input" type="text" id="userCheckbox" name="type" value="driver" hidden>
                            </div>
                        </div>
