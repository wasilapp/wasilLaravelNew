                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-8">
                                            <div class="row">
                                                <div class="form-group mt-0 col-md-6">
                                                    <label for="name">{{__('admin.enTitle')}}</label>
                                                    <input type="text" class="form-control @if($errors->has('manager.name.en')) is-invalid @endif" id="nameEn" name="manager[name][en]" value="{{$shop->manager->getTranslation('name','en');}}" value="{{$shop->manager->getTranslation('name','en');}}">
