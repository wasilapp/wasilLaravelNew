                    ...
                    <div class="card-body">
                        <div class="col-8">
                            <div class="text-right">
                                <a type="button" href="{{route('admin.shops-banners.create')}}"
                                ...
                                @foreach($banners as $banner)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{route('admin.shops-banners.destroy', [$banner->id])}}" class="d-inline" onsubmit="return confirm('Delete this user permanently?')">
