                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <select class="form-control" name="country-code" id="country-code" required>
                ...
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        ...
                        <div class="form-group mb-0 text-center">
                            <button class="btn btn-primary btn-block" type="button" id="btnConfirmOTP"> Confirm OTP
                            </button>
                        </div>

                        <form action="{{route('user.auth.mobile_verified')}}" method="POST" novalidate
                              id="mobileNumberVerifyForm">
                            @csrf
...
<script>
    ...
    btnSendOTP.addEventListener('click', function (e) {
        ...
        const mobileNumber = mobileTF.value;
        if (mobileNumber.length === 0) {
            alert("please fill mobile number");
            return;
        } else {
            self.mobileNumber = mobileNumber.includes('+') ? mobileNumber : countryCodeList[countryCodeSelect.selectedIndex-1].code + mobileNumber;
        }
    ...
    function verifyNumberAndSendOTP(number) {
        $.ajax({
            ...
            url: '{{route('user.auth.verify_mobile_number')}}',
            type: 'POST',
