...
function ($) {
    ...
    */
    LayoutThemeApp.prototype._saveConfig = function(newConfig) {
        ...
        var cacheConfig =  ( window.sessionStorage.getItem('config') ? JSON.parse(window.sessionStorage.getItem('config')) : defaultConfig);
        this.config = $.extend({},cacheConfig, newConfig);
    ...
    LayoutThemeApp.prototype.loadConfig = function() {
        ...
        var config =  ( window.sessionStorage.getItem('config') ? JSON.parse(window.sessionStorage.getItem('config')) : '{}');
